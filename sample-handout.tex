...
\begin{abstract}
\noindent
This document is an example of a \LaTeX\ document - taken from \url{https://github.com/Tufte-LaTeX/tufte-latex}. All credit for the contents and theme to the authors of that class.
\end{abstract}
